...
#define  SHT_3X_SDA_L                                                   GPIO_ResetBits(GPIOA,GPIO_Pin_7)
#define  SHT_3X_SDA_H                                                   GPIO_SetBits(GPIOA,GPIO_Pin_7)
#define  SHT_3X_SCL_L                                                  	GPIO_ResetBits(GPIOA,GPIO_Pin_6)
#define  SHT_3X_SCL_H                                                   GPIO_SetBits(GPIOA,GPIO_Pin_6)


#define  SHT_3X_SDA_IN                                                  GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_7)
#define  SHT_3X_SCL_IN                                                   GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_6)
